...
const WEB_LOCKED = {
  ...
  backendEnv: new Set([
    'PORT', 'WS_PORT', 'RELAY_SECRET', 'SKYMP_HOST', 'SKYMP_PORT', 'SKYMP_UI_PORT', 'SERVER_MASTER_KEY', 'MASTER_URL', 'MASTER_API_AUTH_TOKEN',
    'DISCORD_CLIENT_SECRET', 'DISCORD_REDIRECT_URI', 'DISCORD_BOT_TOKEN', 'DASHBOARD_PORT', 'DASHBOARD_PUBLIC_URL', 'DASHBOARD_API_BASE_URL',
    'DISCORD_DASHBOARD_REDIRECT_URI', 'DASHBOARD_DISCORD_IDS', 'WEBSITE_URL', 'ADMIN_URL', 'ADMIN_TOKEN', 'METRICS_PASSWORD',
    'SERVER_LOCKED', 'SERVER_LOCKED_ROLE_IDS', 'SERVER_LOCKED_ALLOW', 'WHITELIST_ROLE_ID', 'LAUNCH_CHECK_ENFORCE', 'BAN_LOG_DIR',
    'GITHUB_WEBHOOK_SECRET', 'CLIENT_BRANCH', 'CLIENT_FILES_DIR', 'ALDUINAK_GH_TOKEN',
  ]),
}
