...
const serverSettings = [
  ...
  { key: 'gatheringProduceYield',   label: 'Beehive yield',         type: 'json',   group: 'Gameplay', help: '{ "<container editor id>": { "<item editor id>": count } } handed over on E instead of the container record\'s contents. Default: occupied and vacant beehives give 2 Bee Honeycomb, 2 Bee and 2 Beehive Husk, back after an hour (gatheringProduceContainers). Read at boot.' },
  ...
  { key: 'needsSurvivalModeFlag',   label: 'Survival mode flag on clients', type: 'bool', group: 'Gameplay', help: 'On (default): clients set the Creation\'s Survival_ModeEnabled to 1 with each needs update. The engine draws the red penalty segments on the stamina and magicka bars only under that global; off, the HUD zeroes them whatever the penalty globals hold. On also gives every client the engine\'s Survival extras: arrows and bolts weigh 0.1 and armour cards show a Warmth line. Read at boot.' },
