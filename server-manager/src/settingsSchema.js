...
const serverSettings = [
  ...
  { key: 'forbiddenReloot', label: 'Forbidden reloot', type: 'json', group: 'Advanced', help: 'Record types that never respawn; wins over Reloot timers. Item types (MISC, WEAP, ...) and FLOR/TREE: plugin-placed refs cannot be taken at all. "CONT": an emptied container never refills, so storage chests stay player-only. Native server, read at boot.' },
  ...
  { key: 'untouchableBaseIds', label: 'Untouchable objects', type: 'json', group: 'Advanced', help: 'Base form ids nobody can activate (numbers or "0x..." strings). Default: the vanilla coin purses, loose salmon and Stones of Barenziah. [] disables.' },
