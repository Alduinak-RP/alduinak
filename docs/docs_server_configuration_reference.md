...
| `gatheringHarvestSeconds` | `5` | Seconds harvesting a plant or a nirnroot holds the picker kneeling, unable to move or harvest again. `0` skips the kneel. Fish flora (leaping salmon, slaughterfish egg nests, racked salmon, Windhelm's hanging oarfish) never kneel. Catching a bee costs no fatigue and plays nothing |
