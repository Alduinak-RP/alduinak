...
The backend must agree, via its `SKYMP_UI_PORT` environment variable. Values colliding with `port` or outside 1-65535 are rejected and the derived port is used instead.
