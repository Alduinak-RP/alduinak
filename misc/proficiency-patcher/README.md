...
- No `--next-form-id`: every record is found by editor id and reused, and a new one takes the plugin's own next
  ...
  `0x04125C` and `0x04125D`; `0x04125E` and `0x04125F` are reserved for the grain mill; the next one takes
  `0x041260`); the
