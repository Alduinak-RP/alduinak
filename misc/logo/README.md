...
| `logo-96.png` | 96 px | `skymp5-launcher/assets` (topbar emblem, 40 px) and `skymp5-backend/public/images` (dashboard brand mark, 42 px) |
| `icon.ico` | 16, 24, 32, 48, 64, 128, 256 px | `skymp5-launcher/assets/icon.ico`: exe, installer, uninstaller and taskbar icon |
